...
public class SwaggerConfig {
    private ApiInfo createAI(){
        return new ApiInfoBuilder().title("靳帅动作片在线播放").//设置标题
                contact(new Contact("靳帅的爸爸","http://baidu.com","java2004@163.com"))
    ...
    public Docket createD(){
        return new Docket(DocumentationType.SWAGGER_2).//指定生成那种类型的文档
                ...
                .select().apis(RequestHandlerSelectors.basePackage("com.lzb.cloudlike.api.controller")).//扫描接口所在的包
                build();
    }
}
